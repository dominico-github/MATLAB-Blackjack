...
% Clear command window for user's readibility 
clc;
...
while PlayAgain == "yes"
    ...
    while UserInput == "hit"
        ...
        if PlayerCards > 21
            ...
            % Otherwise display a bust statement
                ...
                pause(1); % Pause for user readability 
    ...
    while DealerCards < 17
        ...
        fprintf("Dealer's hand is: %.f\n", DealerCards);
        index = index + 1; % Update index for next draw
        pause(1) % Pause to make text more readable for player
    end
